...
export function EventCard(props: { eventFrontMatter: EventsFrontMatter, slug: string }) {

    return <Link className="xl:w-1/2 cursor-pointer" href={`/events/${props.slug}`}>
        <div className="flex flex-col md:flex-row bg-white shadow-md dark:bg-zinc-800 p-4 rounded-md m-8 hover:shadow-lg duration-200">
            <Image
                height={250}
                width={250}
                objectFit="cover"
